...
public class ProfilePageCommand implements Command {
    ...
    private static final String PROFILE_PAGE = "/view/profile.jsp";

    @Override
    public CommandResponse execute(HttpServletRequest request) throws ServiceException {
        request.getSession().setAttribute(CURRENT_PAGE, PROFILE_PAGE);
        ...
        return new CommandResponse(PROFILE_PAGE, CommandResponse.CommandResponseType.FORWARD);
    }
}